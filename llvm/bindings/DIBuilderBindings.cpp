...
void LLVMAddModuleFlag(LLVMModuleRef mod,
                       ...
                       const char *key,
                       uint32_t val) {
  unwrap(mod)->addModuleFlag(static_cast<llvm::Module::ModFlagBehavior>(behavior), key, val);
}
...
LLVMValueRef LLVMDIBuilderInsertDeclareAtEnd(LLVMDIBuilderRef Dref,
                                             ...
                                             unsigned Col,
                                             LLVMMetadataRef Scope) {
  Instruction *Instr = unwrap(Dref)->insertDeclare(
...
LLVMValueRef LLVMDIBuilderInsertValueAtEnd(LLVMDIBuilderRef Dref,
                                           ...
                                           unsigned Col,
                                           LLVMMetadataRef Scope) {
  Instruction *Instr = unwrap(Dref)->insertDbgValueIntrinsic(
