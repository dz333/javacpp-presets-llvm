...
public static native void LLVMAddModuleFlag(LLVMModuleRef mod,
                       @Cast("ModFlagBehavior") int behavior,
                       @Cast("const char*") BytePointer key,
                       @Cast("uint32_t") int val);
public static native void LLVMAddModuleFlag(LLVMModuleRef mod,
                       @Cast("ModFlagBehavior") int behavior,
                       String key,
                       @Cast("uint32_t") int val);
...
public static native LLVMMetadataRef LLVMDIBuilderCreateAutoVariable(
    ...
    @Cast("unsigned") int Flags, @Cast("uint32_t") int AlignInBits);
public static native LLVMMetadataRef LLVMDIBuilderCreateAutoVariable(
    LLVMDIBuilderRef D, LLVMMetadataRef Scope, String Name,
    LLVMMetadataRef File, @Cast("unsigned") int Line, LLVMMetadataRef Ty, int AlwaysPreserve,
    @Cast("unsigned") int Flags, @Cast("uint32_t") int AlignInBits);
...
public static native LLVMMetadataRef LLVMDIBuilderCreateStructType(
    ...
    @Cast("uint32_t") int AlignInBits, @Cast("unsigned") int Flags, LLVMMetadataRef DerivedFrom,
...
public static native LLVMMetadataRef LLVMDIBuilderCreateReplaceableCompositeType(
    ...
    @Cast("uint64_t") long SizeInBits, @Cast("uint32_t") int AlignInBits, @Cast("unsigned") int Flags);
public static native LLVMMetadataRef LLVMDIBuilderCreateReplaceableCompositeType(
...
public static native LLVMMetadataRef LLVMDIBuilderCreateMemberType(LLVMDIBuilderRef D, LLVMMetadataRef Scope,
                              ...
                              @Cast("uint32_t") int AlignInBits, @Cast("uint64_t") long OffsetInBits,
...
public static native LLVMValueRef LLVMDIBuilderInsertDeclareAtEnd(LLVMDIBuilderRef Dref,
                                             ...
                                             @Cast("unsigned") int Col,
                                             LLVMMetadataRef Scope);

public static native LLVMValueRef LLVMDIBuilderInsertValueAtEnd(LLVMDIBuilderRef Dref,
                                           LLVMValueRef Val, @Cast("uint64_t") long Offset,
                                           LLVMMetadataRef VarInfo,
                                           LLVMMetadataRef Expr,
                                           LLVMBasicBlockRef Block,
                                           @Cast("unsigned") int Line,
...
public static class LLVMDebugLocMetadata extends Pointer {
    static { Loader.load(); }
    /** Default native constructor. */
    public LLVMDebugLocMetadata() { super((Pointer)null); allocate(); }
    /** Native array allocator. Access with {@link Pointer#position(long)}. */
    public LLVMDebugLocMetadata(long size) { super((Pointer)null); allocateArray(size); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public LLVMDebugLocMetadata(Pointer p) { super(p); }
    private native void allocate();
    private native void allocateArray(long size);
    @Override public LLVMDebugLocMetadata position(long position) {
        return (LLVMDebugLocMetadata)super.position(position);
    }

    public native @Cast("unsigned") int Line(); public native LLVMDebugLocMetadata Line(int Line);
    public native @Cast("unsigned") int Col(); public native LLVMDebugLocMetadata Col(int Col);
    public native LLVMMetadataRef Scope(); public native LLVMDebugLocMetadata Scope(LLVMMetadataRef Scope);
    public native LLVMMetadataRef InlinedAt(); public native LLVMDebugLocMetadata InlinedAt(LLVMMetadataRef InlinedAt);
}
...
public static native @ByVal LLVMDebugLocMetadata LLVMGetCurrentDebugLocation2(LLVMBuilderRef Bref);
